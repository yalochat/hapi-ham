...
const getSend = (data, config, logger) => (message, _options) => {
  ...
  if (notification) {
    const notificationPayload = { bot_id: _options.botSlug, message: payload }
    KafkaClient.produce('whatsapp-outcoming', 0, notificationPayload)
  }
